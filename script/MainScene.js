    ...
    function MainScene(param) {
        ...
        _this.loaded.add(function () {
            ...
            if (typeof window !== "undefined") {
                ...
                if (seed)
                    _this.random = new g.XorshiftRandomGenerator(parseInt(seed));
            ...
            uiBase.hide();
            //タイトル
            var sprTitle = new g.Sprite({ scene: _this, src: _this.assets["title"], x: 0 });
            ...
            //タイム
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["time"], x: 505, y: 320 }));
            var labelTime = new g.Label({ scene: _this, font: numFont, fontSize: 32, text: "70", x: 545, y: 323 });
